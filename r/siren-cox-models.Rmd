...
explanatory_multi = c("vaccine_cat", "primary_inf", "strata(agegr)", "strata(work_exposure_frequency)", "cluster(trust_code)")
...
dependent = "Surv(tstart, tstop, event)"
explanatory_uni = "vaccine_cat"
explanatory_multi = c("vaccine_cat", "primary_inf", "gender", "ethngr", "strata(region)", "strata(agegr)", "strata(work_exposure_frequency)", "cluster(trust_code)")
